...
author: "Tudor, 'sunmengchuan',Jiacheng Zhang - Templers"
...
data of Chinese is wrong
area is not proportional to the numbers
...
using pie chart to represent individual data instead of ratio in total, etc.
...
cannot see each observation clearly
...
data from different countries should be represented seperately
...
ggplot(data = staff_long,
       mapping = aes(x = year, 
                     ...
                     colour = faculty_type)) +
  geom_line() + 
  labs(title = "Changes of faculty in 40 years")
